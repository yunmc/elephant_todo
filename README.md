...
elephant_app/
├── assets/css/          # 全局样式
├── composables/         # Vue composables (useApi, useVaultCrypto, useVoiceInput)
├── docs/                # 需求文档、数据库设计
